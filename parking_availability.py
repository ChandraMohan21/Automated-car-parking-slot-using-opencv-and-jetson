...
def parking_availability():
    ...
    print("Length of parking_lot_image:", len(parking_lot_image))
    print("Length of parking_lot_coords:", len(parking_lot_coords))

    for i in range(len(parking_lot_image)):
        if i < len(parking_lot_coords):  # Add this check to avoid index out of range
            ...
            print(f"Warning: parking_lot_coords index {i} is out of range.")
